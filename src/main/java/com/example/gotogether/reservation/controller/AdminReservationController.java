...
@Api(tags = {"관리자 예약 서비스"}, description = "전체 예약 목록 조회, 예약상태 수정")
...
public class AdminReservationController {
    ...
    @GetMapping
    public ResponseEntity<?> findAllList(@RequestParam(required = false, defaultValue = "1") int page) {
        return reservationService.findAllList(page);
    }
