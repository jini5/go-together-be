...
public class AuthController {
    ...
    @PostMapping("/signup")
    @ApiOperation(value = "회원가입 (토큰 X)", notes = "정보를 입력받아 회원가입을 진행하고 DB에 저장. code: 201 회원가입 성공, 400 email 이 존재하거나 두 패스워드가 불일치")
    ...
    @PostMapping("/login")
    @ApiOperation(value = "로그인 (토큰 X)", notes = "이메일과 패스워드를 입력받아 로그인이 가능 성공하면 토큰발급 code: 200 로그인 성공, 401 탈퇴한 회원, 404 없는회원 또는 비밀번호 불일치")
